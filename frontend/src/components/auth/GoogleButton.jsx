...
export default function GoogleButton({ children, ...props }) {
  return (
    <button
      type="button"
      className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-surface py-2.5 text-sm font-medium text-text transition-colors hover:bg-white/5"
      {...props}
    >
